...
<div class="lr-box w">
    ...
    <div class="box-r">
        <form method="post">
            ...
            <div>
                <input type="text" value=""  name="userName" class="form-control" id="userName" placeholder="用户名">
            </div>
            <div>
                <input type="password" value="" name="userPwd" class="form-control" id="userPwd"
